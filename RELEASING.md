...
This document defines the release policy for **victron-venus/inverter-dashboard-vue**. The
...
The committed base version comes from `package.json`. A release preparation PR
...
- SPA and library tarballs are promoted unchanged. Browser/device acceptance remains a release operator check.
